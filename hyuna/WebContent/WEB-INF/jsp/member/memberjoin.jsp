...
<script type="text/javascript">
	...
	$(function(){		
		...
		$("#agr_agreeCheck1").click(function(){
			if(($("#agr_agreeCheck1").is(":checked"))){
				$("#agr1_msg").text("");
			}
		});
		$("#agr_agreeCheck2").click(function(){
...
<div id="wrapper">
		...
		<table class="table" style="border: 1px solid #ddd">
			<tr>
				...
				<div>
					...
					&nbsp;<button type="button" id="idCheck">아이디 중복확인</button>&nbsp;(영문소문자/숫자, 4~16자)<span id="id_msg"></span>
				</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><label id="as"></label>뉴스 메일을 받으시겠습니까?								
					...
					<input type="radio" class="radio" name="mem_mailCheck" >수신안함
	...
	<div style="border: 1px solid #ddd">	
		<div style="margin-top: 15px; margin-bottom: 15px" class="col-md-12">
			<textarea readonly="readonly" class="form-control" rows="10" style="background: white">				
${list.content }
			</textarea>			
		</div>
		<div style="margin: 20px">${list.title } 동의하십니까?&nbsp;<input type="checkbox" id="agr_agreeCheck1" name="agr_agreeCheck">동의함&nbsp;<span id="agr1_msg"></span></div>
	</div>
	</c:forEach>
<!-- 	<h4>개인정보 수집 및 이용 동의</h4>
	<div style="border: 1px solid #ddd">	
		...
		<div style="margin: 20px">개인정보 수집 및 이용에 동의하십니까?&nbsp;<input type="checkbox" id="agr_agreeCheck2" name="agr_agreeCheck">동의함&nbsp;<span id="agr2_msg"></span></div>
	</div> -->
